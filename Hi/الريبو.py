...
@Client.on_message(filters.user(OWNER_ID) & filters.command(['ب'], prefixes=f"{HNDLR}"))
...
**ملاحظه** : اوامر البوت بدون ماتخلي نقطه ويه الامر وبس .
...
**توقف مؤقت** : [ `‏{HNDLR}استئناف` ] .
**تلغي مؤقت** : [ `‏{HNDLR}ايقاف_استئناف` ] .
...
The Channel : @flanbott [.](https://telegra.ph/file/699d94128c60557833ae5.mp4) 
"""
    await m.reply(HELP)
